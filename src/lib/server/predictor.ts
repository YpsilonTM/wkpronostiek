...
function tryParsePrediction(rawText: string): Record<string, unknown> {
...
async function repairPrediction(ai: GoogleGenAI, malformedText: string): Promise<Record<string, unknown>> {
	const repairPrompt = `
...
function needsEscalation(prediction: ReturnType<typeof normalizePrediction>): boolean {
